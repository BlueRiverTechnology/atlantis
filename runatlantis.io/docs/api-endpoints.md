...
:::warning Branch Mode (PR=0)
- No VCS commit status updates
- Concurrent branch plans share locks → conflicts possible
- `Ref` must be branch name (no SHA support)
- MVP feature - experimental
:::
